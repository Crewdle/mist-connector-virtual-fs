...
class FileTypeParser {
	...
	async toDetectionStream(readableStream, options = {}) {
		const {default: stream} = await Promise.resolve(/* import() */).then(__webpack_require__.t.bind(__webpack_require__, 75, 19));
...
;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/core/node/NodeType.js
/**
 * The node type enum.
 * @category Core
 */
...
;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/core/node/index.js




;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/core/stream/ContentType.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/core/stream/index.js


;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/core/index.js
...
;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/key-value-database/DatabaseEvent.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/key-value-database/index.js


;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/media-stream/MediaStreamPriority.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/media-stream/index.js



;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/object-storage/event/StorageEventType.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/object-storage/event/index.js


;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/object-storage/ObjectKind.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/object-storage/PayloadAction.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/object-storage/index.js




;// CONCATENATED MODULE: ./node_modules/@crewdle/web-sdk-types/dist/index.js
...
function encrypt(buffer, key) {
    const iv = external_crypto_namespaceObject.randomBytes(16);
    const cipher = external_crypto_namespaceObject.createCipheriv(algorithm, key, iv);
...
function decrypt(encrypted, key) {
    ...
    const decipher = external_crypto_namespaceObject.createDecipheriv(algorithm, key, iv);
 ...
 * @ignore
 */
class FilePolyfill extends external_buffer_namespaceObject.Blob {
    /**
...
;// CONCATENATED MODULE: ./src/models/VirtualFSObjectStoreConnector.ts
...
class VirtualFSObjectStoreConnector {
    ...
    async get(path) {
        ...
        const encrypted = external_fs_namespaceObject.readFileSync(internalPath);
        const decrypted = decrypt(encrypted, this.storeKey);
    ...
    async list(path, recursive) {
        const internalPath = getPathName(this.rootPath, path);
        const objects = external_fs_namespaceObject.readdirSync(internalPath);
        const descriptors = [];
        for (const object of objects) {
            const stats = external_fs_namespaceObject.statSync(`${internalPath}/${object}`);
    ...
    async createFolder(path) {
        const internalPath = getPathName(this.rootPath, path);
        external_fs_namespaceObject.mkdirSync(internalPath, { recursive: true });
    }
    /**
     * Write a file.
     * @param file The file.
    ...
    async writeFile(file, path) {
        ...
        if (!external_fs_namespaceObject.existsSync(internalPath)) {
            external_fs_namespaceObject.mkdirSync(internalPath, { recursive: true });
        }
        external_fs_namespaceObject.writeFileSync(internalPath, encrypted);
    }
    /**
     * Move an object.
     * @param path The path.
     ...
     */
    async moveObject(path, newPath) {
        const internalPath = getPathName(this.rootPath, path);
        const internalNewPath = getPathName(this.rootPath, newPath);
        const [newPathParent] = splitPathName(internalNewPath);
        if (!external_fs_namespaceObject.existsSync(newPathParent)) {
            external_fs_namespaceObject.mkdirSync(newPathParent, { recursive: true });
        }
        external_fs_namespaceObject.renameSync(internalPath, internalNewPath);
        const stats = external_fs_namespaceObject.statSync(internalNewPath);
    ...
    async deleteObject(path) {
        const internalPath = getPathName(this.rootPath, path);
        const stats = external_fs_namespaceObject.statSync(internalPath);
        if (stats.isDirectory()) {
            external_fs_namespaceObject.rmdirSync(internalPath, { recursive: true });
            return ObjectKind.Folder;
        }
        else {
            external_fs_namespaceObject.unlinkSync(internalPath);
